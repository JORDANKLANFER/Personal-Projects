...
We used <a href="https://www.ebi.ac.uk/jdispatcher/msa">Clustal Omega</a> to conduct Multiple Sequence Alignments for our target proteins (namely Gag-pol, Env, and Tat proteins) among HIV-1 Subtypes C and B; HIV-2 Subtypes A and B; SIVcpz isolate MB66. You can reference the data in included_alignment_data in order to upload folders to Jbrowse MSA plugin to view the phlogenetic tree and alignment details. Here, we display the resulting alignment heat maps for each target protein of interest.
